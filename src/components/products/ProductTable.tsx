        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border bg-muted/50">
              <th className="px-4 py-3 text-right text-sm font-semibold text-muted-foreground">الباركود</th>
              <th className="px-4 py-3 text-right text-sm font-semibold text-muted-foreground">الاسم التجاري</th>
              <th className="px-4 py-3 text-right text-sm font-semibold text-muted-foreground">الاسم العلمي</th>
              <th className="px-4 py-3 text-right text-sm font-semibold text-muted-foreground">التصنيف</th>
              ...
              <th className="px-4 py-3 text-right text-sm font-semibold text-muted-foreground">تاريخ الانتهاء</th>
