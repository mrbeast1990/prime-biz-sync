...
export default function POS() {
        ...
        cart.map((item) =>
          item.product.id === product.id
            ? {
                ...
                total: (item.quantity + 1) * item.product.salePrice,
              }
            : item
        )
      );
  ...
  const handleCheckout = (paymentMethod: 'cash' | 'card') => {
    ...
    toast({
      ...
      description: `تم إتمام عملية البيع بقيمة ${total.toFixed(2)} ر.س`,
    });
    clearCart();
  };
          ...
          <form onSubmit={handleBarcodeSubmit} className="mb-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pr-10 h-12 text-lg font-mono input-focus"
              />
            </div>
          </form>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {item.product.salePrice.toFixed(2)} ر.س
                        </p>
                      </div>
                      <Button
                        variant="ghost"
